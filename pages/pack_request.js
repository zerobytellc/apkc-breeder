...
export default function Guides() {
  ...
  return (
    <div className={styles.guides}>
      <h2>Become an APKC Recognized Breeder</h2>
            ...
            <form name="APKC Breeder Request" method="post" data-netlify="true" onSubmit="submit">
                <input type="hidden" name="form-name" value="APKC Breeder Request"/>
                <p>
